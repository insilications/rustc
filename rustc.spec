...
Version  : 1.8.0
Release  : 12
URL      : https://static.rust-lang.org/dist/rust-1.8.0-x86_64-unknown-linux-gnu.tar.gz
Source0  : https://static.rust-lang.org/dist/rust-1.8.0-x86_64-unknown-linux-gnu.tar.gz
...
Summary: Rust compiler
Group: Libraries%
Provides: librustc_driver-4fda350b.so()(64bit)
Provides: librustdoc-4fda350b.so()(64bit)
Provides: libstd-4fda350b.so()(64bit)

%description lib
Rust compiler

%prep
%setup -q -n rust-1.8.0-x86_64-unknown-linux-gnu
