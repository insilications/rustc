...
Source0:        https://static.rust-lang.org/dist/rust-1.39.0-x86_64-unknown-linux-gnu.tar.gz

Requires:       binutils
Requires:       gcc
Requires:       gcc-dev
Requires:       libc6-dev
Provides:       libLLVM-9-rust-1.39.0-stable.so()(64bit)
Provides:       libLLVM-9-rust-1.39.0-stable.so(LLVM_9)(64bit)
Provides:       cargo
...
%setup -q -n rust-1.39.0-x86_64-unknown-linux-gnu
